...
var ConfigSchema = z.object({
  ...
  fetchArgs: z.object({}).default({}).describe("Arguments to pass to fetch when loading the model."),
...
async function runInference(imageTensor, config, session) {
  ...
  return (0, import_ndarray4.default)(tensorImage.data, [dst_height, dst_width, 4]);
}
...
async function removeBackground(image, configuration) {
  ...
  return await imageEncode(outImageTensor);
}
